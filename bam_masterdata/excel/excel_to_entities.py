    ...
    VALIDATION_RULES: dict[str, dict[str, dict[str, Any]]] = {
        "SAMPLE_TYPE": {
            ...
            "Validation script": {
                ...
                "allow_empty": True,  # Allow empty but validate if present
            },
            "Generated code prefix": {
                "key": "generatedCodePrefix",
                "pattern": r".*",
                "extra_validation": "is_reduced_version",  # Calls is_reduced_version()
            },
            "Auto generated codes": {
                "key": "autoGeneratedCode",
                "pattern": None,
                "is_bool": True,
            },
        },
        "OBJECT_TYPE": {  # Same as SAMPLE_TYPE
            "Code": {"key": "code", "pattern": r"^\$?[A-Za-z0-9_.]+$"},
            "Description": {
                "key": "description",
                "pattern": r".*",
        ...
        "PROPERTY_TYPE": {
            ...
            "Property label": {"key": "label", "pattern": r".*"},
            "Data type": {
                "key": "dataType",
                "pattern": None,
                "is_data": True,  # Explicitly enforce allowed types
            },
            "Vocabulary code": {
                "key": "vocabularyCode",
                "pattern": r"^\$?[A-Za-z0-9_.]+$",
            },
            "Metadata": {"key": "metadata", "pattern": r".*"},
            "Dynamic script": {
                "key": "plugin",
                "pattern": r"^[A-Za-z0-9_]+\.py$",
                "allow_empty": True,
        ...
        "VOCABULARY_TYPE": {  # This was missing
            "Code": {"key": "code", "pattern": r"^\$?[A-Za-z0-9_.]+$"},
            "Description": {
                "key": "description",
                "pattern": r".*",
            ...
            "Url template": {
                ...
                "is_url": True,
                "allow_empty": True,  # Allows empty but validates URLs if present
            },
        },
    }
